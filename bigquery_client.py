...
# This file recycles a set of utility functions and api wrappers that  underly
# the bq command line utilities (bq/bigquery_client.py)
...
class BigqueryClient(object):
  ...
  def Query(self, query,
    ...
    _ApplyParameters(request, dry_run=dry_run)
    return self.ExecuteJob(request, project_id=project_id, **kwds)
